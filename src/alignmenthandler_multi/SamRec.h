...
public:
	...
	size_t head_soft_clip;
	
	size_t tail_soft_clip;
	...
	/*is_insert(false),*/ mappedlen(0), intron_size(0), min_anchor(-1), max_anchor(0), head_soft_clip(0), tail_soft_clip(0), pair_rate(0), m_contig_len(0), 
	...
	string tostandfusion(size_t total, size_t idx) const;
